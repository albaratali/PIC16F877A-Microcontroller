...
{
    CLCD_RS = (__bit)mode; // RE2 (here, (__bit) use for single data type)
...
static void init_display_controller(void)
{
    ...
    /*This function is written in CLCD display Data Sheet(45 page)*/
    __delay_ms(30);// setup cristal frequency 20MHz
